...
The three lines of code within the [`try`](/ja/docs/Web/JavaScript/Reference/Statements/try...catch) block perform the following steps:
...
- [WebRTC connectivity](/ja/docs/Web/API/WebRTC_API/Connectivity)
- [Introduction to WebRTC protocols](/ja/docs/Web/API/WebRTC_API/Protocols)
- [Lifetime of a WebRTC session](/ja/docs/Web/API/WebRTC_API/Session_lifetime)
